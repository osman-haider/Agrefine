...
public class NewProductUploadActivity extends AppCompatActivity {
    EditText PFName,PFPrice,PFDiscription;
    ImageView PFImage;
    Button buttonupload;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(receivedValue.equals("update")){
            Toast.makeText(this, "you are in update product", Toast.LENGTH_SHORT).show();
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            Toast.makeText(NewProductUploadActivity.this, "update product", Toast.LENGTH_SHORT).show();
                                            ...
                                            Toast.makeText(NewProductUploadActivity.this, "not updated", Toast.LENGTH_SHORT).show();
                                            progressDialog.dismiss();
                                        }
                                    }
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(NewProductUploadActivity.this, "faial", Toast.LENGTH_SHORT).show();
                                        progressDialog.dismiss();
                                    }
                                });
                    }
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                productRef.set(updatedFields, SetOptions.merge())
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    Toast.makeText(NewProductUploadActivity.this, "product is updated", Toast.LENGTH_SHORT).show();
                                    progressDialog.dismiss();
                                    PFName.setText("");
                                    PFDiscription.setText("");
                                    PFPrice.setText("");
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                imageStorageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        Toast.makeText(NewProductUploadActivity.this, "uploaded", Toast.LENGTH_SHORT).show();
                        ...
                        newProductRef.set(productData)
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void unused) {
                                        Toast.makeText(NewProductUploadActivity.this, "whole data is uploaded", Toast.LENGTH_SHORT).show();
                                        progressDialog.dismiss();
                                        PFName.setText("");
                                        PFDiscription.setText("");
                                        PFPrice.setText("");
                                    ...
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(NewProductUploadActivity.this, "whole data is not uploaded", Toast.LENGTH_SHORT).show();
                                        progressDialog.dismiss();
                                    }
                                });
